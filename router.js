...
const loaders = {
  ...
  "/attendance-monitor": async () => (await import('./pages/attendanceMonitor.js')).renderAttendanceMonitorPage,
  ...
  "/permission": async () => (await import('./pages/permission.js')).renderPermissionPage,
